<%@ Page Title="" Language="C#" MasterPageFile="~/Denver/FlexibleTennisLeague.Master" AutoEventWireup="true" CodeBehind="NoRegister.aspx.cs" Inherits="FlexibleTennisLeague.Denver.Users.NoRegister" %>
...
<h2>Denver league's playoffs are currently in progress, so we are sorry to say that we will not be able to enroll you at this point of time.</h2>
