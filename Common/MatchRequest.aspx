<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatchRequest.aspx.cs" Inherits="FlexibleTennisLeague.Common.MatchRequest" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Submit Match Request</title>
...
<body style="width: 310px;" >
    ...
    <div class="greyContent" style="width: 300px">
        ...
        <br />
        <asp:Label ID="Label1" runat="server" Text="Please allow more than 24 hours while scheduling a match."></asp:Label>
