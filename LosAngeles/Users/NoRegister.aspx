<%@ Page Title="" Language="C#" MasterPageFile="~/LosAngeles/FlexibleTennisLeague.Master" AutoEventWireup="true" CodeBehind="NoRegister.aspx.cs" Inherits="FlexibleTennisLeague.LosAngeles.Users.NoRegister" %>
...
<h2>Los Angeles league's playoffs are currently in progress, so we are sorry to say that we will not be able to enroll you at this point of time.</h2>
