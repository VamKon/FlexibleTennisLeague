<%@ Page Title="" Language="C#" MasterPageFile="~/Chicago/FlexibleTennisLeague.Master" AutoEventWireup="true" CodeBehind="NoRegister.aspx.cs" Inherits="FlexibleTennisLeague.Chicago.Users.NoRegister" %>
...
<h2>Chicago league's playoffs are currently in progress, so we are sorry to say that we will not be able to enroll you at this point of time.</h2>
