<%@ Page Title="" Language="C#" MasterPageFile="~/Atlanta/FlexibleTennisLeague.Master" AutoEventWireup="true" CodeBehind="NoRegister.aspx.cs" Inherits="FlexibleTennisLeague.Atlanta.Users.NoRegister" %>
...
<h2>Atlanta league's playoffs are currently in progress, so we are sorry to say that we will not be able to enroll you at this point of time.</h2>
