<%@ Page  Title="Flexible Tennis League | Chicago, IL | Recover Password" Language="C#" MasterPageFile="~/Chicago/FlexibleTennisLeague.Master" AutoEventWireup="true" CodeBehind="RecoverPassword.aspx.cs" Inherits="FlexibleTennisLeague.Chicago.RecoverPassword" %>
...
<div style="float: left">
            ...
            <div class="tennisBallBanner" align="right">
               <RP:RecoverPassword ID="RecoverPassword1" runat="server" DestinationPageURL="~/Chicago/LoginPage.aspx"></RP:RecoverPassword>
            </div>
        </div>
